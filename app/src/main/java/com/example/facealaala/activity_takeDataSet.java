...
public class activity_takeDataSet extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_take_data_set);
        ...
        numberOfPictures = Integer.valueOf(sharedPref.getString("key_numberOfPictures", "15"));
    ...
    public void onCameraViewStopped() {
        //write code to train data immediately. maybe can get through this maybe not
    }
                    ...
                    if((faces != null) && (faces.length == 1)){
                        ...
                        if(((method == MANUALLY) && capturePressed) || (method == TIME)){
                            ...
                            if(total >= numberOfPictures){
                                ...
                                //maybe can train from this, maybe not.
